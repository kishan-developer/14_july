      ...
      <div className='nav_row bg-white lg:w-full md:w-full' >
        ...
        <div className='menubutton text-3xl flex absolute left-6 top-3 cursor-pointer'>
          ...
          <Link to='/' className='p-1 ml-3'>
            <img src="https://itokri.com/cdn/shop/files/Group_1458_2x_95f81960-e86c-4e73-a9e2-9b93370be915.png?v=1660109560&width=120" alt="mini_logo" />
          </Link>
        </div>
          ...
          <div className="logo lg:flex  ">
            <Link to='/'>
              <img className='logo_img h-5 lg:flex '
                src="https://itokri.com/cdn/shop/files/Group_1458_2x_95f81960-e86c-4e73-a9e2-9b93370be915.png?v=1660109560&width=120"
                alt="" />
