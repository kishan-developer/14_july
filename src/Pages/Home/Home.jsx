...
function Home() {
  ...
  return (
    <div className='home w-full h-fit block overflow-hidden bg-red-50'>
      ...
      <div className=" w-full lg:h-[550px] md:h-[400px] sm:h-[300px] h-[130px] xl:mb-10 lg:mb-10 ">
        <TopSection />
        {/* <Carousel/> */}
      </div>

      <div className="xl:px-10 lg:px-10 w-full h-[auto] text-center text-black text-sm ">
        <P_Cards />
      </div>


      <div className="block w-full xl:h-[40rem] lg:h-[40rem] md:h-[30rem] sm:h-[20rem] h-[10rem] py-2 mb-20">
        ...
        <div className="images flex w-full xl:h-[40rem] lg:h-[40rem] md:h-[30rem] sm:h-[20rem] h-[10rem]">
      ...
      <div className="block w-full py-10 ">
        <h2 className='w-full  text-center xl:text-3xl lg:text-3xl md:text-lg text-[0.8rem] font-bold mt-20 mb-[2%] '>
      ...
      <div className="view_more">
        ...
        <div className="w-full h-[auto]">
          {/* popular category*/}
          <div className="w-full flex flex-col text-center items-center justify-center  mb-5">
            <span className="border-b-2 border-black text-[1rem] font-bold mb-10 mt-20">View More</span>
            <h2 className="text-[2rem] font-bold text-center">POPULAR CATEGORIES</h2>
